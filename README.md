...
مواقيت صلاة دقيقة: حسابات دقيقة بناءً على موقعك والمذهب الفقهي (شافعي/حنفي).
تنبيهات ذكية: أذان كامل وتنبيهات قبل الصلاة لتكون دائماً على استعداد.
القرآن الكريم: تصفح المصحف كاملاً بخط واضح، مع التفسير والتلاوات الصوتية.
الأذكار والأدعية: مكتبة شاملة لأذكار الصباح والمساء، وأدعية من القرآن والسنة، مع مسبحة إلكترونية.
اتجاه القبلة: بوصلة دقيقة لتحديد اتجاه الكعبة المشرفة من أي مكان.
البحث عن المساجد: اعثر على أقرب المساجد إليك بلمسة واحدة.
التقويم الهجري: متابعة التواريخ والمناسبات الإسلامية.
قضاء الفوائت: أداة خاصة لمساعدتك في حساب ومتابعة الصلوات الفائتة.
النوافل والسنن: دليل ومتابعة لسنن الصلوات.
تصميم فاخر: واجهة "الزمرد العميق" المريحة للعين والتي تضفي خشوعاً وجمالاً.
عمل بدون إنترنت: معظم المميزات تعمل بكفاءة دون الحاجة لاتصال دائم.
ويدجت (Widget): إضافات للشاشة الرئيسية لعرض أوقات الصلاة بشكل جميل.
خصوصية تامة: نحن نحترم خصوصيتك، التطبيق لا يجمع أي بيانات شخصية.
